...
class GraphAPI {
    ...
    func queryAllNotes(_ completion: @escaping (Swift.Result<[NoteFullDetails]?, Error>) -> Void) {        
    ...
    func addNote(title: String, body: String, creationDate: String, _ completion: @escaping (Error?) -> Void) {
    ...
    func updateNote(note: NoteFullDetails, _ completion: @escaping (Error?) -> Void) {
